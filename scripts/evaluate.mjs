 ...
 * Usage:
 *   node scripts/evaluate.mjs                      # Runs full suite on all available data
 *   node scripts/evaluate.mjs --type text ...      # Runs specific text evaluation
 *   node scripts/evaluate.mjs --type lambada ...   # Runs specific lambada evaluation
 */
