# Abstract Primitives Benchmarks for BSP

This directory contains **20 synthetic benchmarks (abstract primitives)** designed to evaluate BSP's ability to model fundamental "shapes" of information.
...
### Tier 3: Learning & Robustness (XVI-XX)
...
## Output: Abstract Primitives Profile
...
- [DS-019: Synthetic Abstract Primitives Benchmarks](../../docs/specs/DS/DS-019-synthetic-evaluation.md) - Full specification
